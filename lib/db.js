...
async function createTables(client) {
  ...
  await client.query(
    "CREATE TABLE IF NOT EXISTS stockyard.cloc \
    (owner varchar, \
      repository varchar, \
      branch varchar, \
      created_at timestamptz, \
      contents jsonb, \
      PRIMARY KEY (owner, repository, branch, created_at));"
  );
