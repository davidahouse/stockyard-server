...
const imagecapture = require("./db/imagecapture");
const imagecapturediff = require("./db/imagecapturediff");
...
async function start(conf, logger) {
  ...
  if (conf.dbCert != null) {
    ...
    imagecapture.setPool(pool, conf, logger);
    imagecapturediff.setPool(pool, conf, logger);
  }
...
async function createTables(client) {
  ...
  await imagecapture.createTables();
  await imagecapturediff.createTables();
...
module.exports.imagecapture = imagecapture;
module.exports.imagecapturediff = imagecapturediff;
